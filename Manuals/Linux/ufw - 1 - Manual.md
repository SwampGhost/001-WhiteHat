SOURCES: http://manpages.ubuntu.com/manpages/bionic/man8/ufw.8.html
...
############################# OPTIONS #############################
 --version
       ...
       default allow|deny|reject DIRECTION
			  ...
			  ## incoming, outgoing or routed. Note that existing rules will  have  to  be  
			  ## migrated manually  when  changing  the  default policy. See RULE SYNTAX for more on
			  ## deny and reject.
       ...
       reset  
	   		## Disables  and  resets  firewall to installation defaults. Can also give the --force
            ##   option to perform the reset without confirmation.

       status 
	   		## show status of firewall and  ufw  managed  rules.  Use  status  verbose  for  extra
